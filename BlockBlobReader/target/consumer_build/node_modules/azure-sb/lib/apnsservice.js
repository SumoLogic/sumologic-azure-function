...
* @param {object|function}            [optionsOrCallback.headers]    The apns headers.
...
* });
*/
ApnsService.prototype.send = function (tags, payload, optionsOrCallback, callback) {
    var options;
  ...
  if (!_.isString(payload)) {
    ...
    if(payload.priority) {
      headers[HeaderConstants.SERVICE_BUS_NOTIFICATION_APNS_PRIORITY] = payload.priority;
...
* @param {object|function}            [optionsOrCallback]                    The request options or callback function.
* @param {object|function}            [optionsOrCallback.headers]            The apns headers to include.
* @param {Function(error, response)}  callback            `error` will contain information
*                                                         if an error occurs; otherwise, `response`
*                                                         will contain information related to this operation.
*/
...
* @param {object}                     [template.payload]  If the 'aps' member is not provided, the payload object that contains the notification text.
* @param {object}                     [options]           The request options.
* @param {object}                     [options.headers]   The apns headers to include.
* @param {Function(error, response)}  callback            `error` will contain information
*                                                         if an error occurs; otherwise, `response`
*                                                         will contain information related to this operation.
*/
...
ApnsService.prototype._createBody = function (elementName, token, tags, template, options) {
  ...
  if (template) {
    ...
    if (options) {
        if (options.headers) {
            registration.ApnsHeaders = { ApnsHeader: [] };
            Object.keys(options.headers).forEach(function (headerName) {
                registration.ApnsHeaders.ApnsHeader.push({ Header: headerName, Value: options.headers[headerName] });
            });
        }
    }
...
* @param {json}               template                            The template for the registration.
* @param {object|function}    [options]                           The request options or callback function.
* @param {object|function}    [options.headers]                   The apns headers to include.
* @return {string}  The template body.
*/
